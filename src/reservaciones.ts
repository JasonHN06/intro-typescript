...
type TipoPelicula = 'Accion' | 'Comedia' | 'Drama' | 'Infantil';
...
type EstadoReserva = 'Confirmada' | 'Pendinte' | 'Cancelada';
...
export const actualizarEstado = (reserva: Reserva, nuevoEstado: 
...
export const filtrarPeliculasPorGenero = (cartelera: Pelicula[],
genero: TipoPelicula) : Pelicula[] => {
